...
def process_amazon(root):
    """
    Dataset from https://snap.stanford.edu/data/amazon/productGraph/
    From : Predicting Dynamic Embedding Trajectory in Temporal Interaction Networks  https://dl.acm.org/doi/10.1145/2488388.2488466
...
def load_dataset(dataset, train_ratio=0.7, val_ratio=0.15, test_ratio=0.15, zero_edge=False):
    if 'amazon' in dataset:
        ...
        data = TemporalData(
            src=edge_index[0], dst=edge_index[1], t=t, y=labels
        )
        ...
        # JODIE Datasets ( Wikipedia , Mooc ) : 
        # From Predicting Dynamic Embedding Trajectory in Temporal Interaction Networks  : https://dl.acm.org/doi/10.1145/3292500.3330895
        # Source : https://snap.stanford.edu/jodie/
